...
export class ImageLayoutService {
  ...
  addImageItem(item: IimageList) {
    return this.http.post<IimageList>(
      `${environment.apiEndpoint}/imageList`,
      item
    );
    // .pipe(
    //   map((data) => {
  ...
  editImageItem(item: IimageList) {
    return this.http.put<IimageList>(
      `${environment.apiEndpoint}/imageList/${item.id}`,
      item
    );
    // .pipe
    // map((data) => {
  ...
  deleteImageItem(item: IimageList) {
    return this.http.delete<IimageList>(
      `${environment.apiEndpoint}/imageList/${item.id}`
    );
    // .pipe
    // map((data) => {
